...
import { useNavigationMenu, withNavigationMenu } from '../features/access-control/context'
        ...
        <div className='overflow-hidden'>
            ...
            <Drawer open={isDrawerOpen} direction='left' fixed onDrag={toggleDrawer}>
                <DrawerContent className='w-72 h-full bg-white shadow'>
                    <DrawerClose className='absolute right-1 top-1 shadow-sm rounded-full w-fit p-2 cursor-pointer' onClick={toggleDrawer}>
