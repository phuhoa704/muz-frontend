        ...
        <form id="cusongform">
          <DialogContent>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <Input {...field} placeholder="Song name" id="name" className='border rounded-md border-primary px-2 py-1.5' />
                  <FormMessage />
                </FormItem>
              )}
            />
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <Select {...field} options={artists?.data.map(t => ({ label: t.name, value: t.id }))} isMulti placeholder='Artist(s)' />
                </FormItem>
              )}
            />
            <div className="grid grid-cols-2 gap-4">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <Input {...field} placeholder="Minute(s)" id="minutes" type="number" className='border rounded-md border-primary px-2 py-1.5' />
                  </FormItem>
                )}
              />
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <Input {...field} placeholder="Second(s)" id="seconds" type="number" className='border rounded-md border-primary px-2 py-1.5' />
                  </FormItem>
                )}
              />
            </div>
