        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className='space-y-4' id='loginForm'>
          <FormField control={form.control} name='email' render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input placeholder='Enter your email' className='border rounded-md border-primary px-2 py-1.5' {...field} id='emailInput' />
              </FormControl>
              <FormMessage />
            </FormItem>
          )} />
          ...
          <FormField control={form.control} name='password' render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input placeholder='Enter your password' className='border rounded-md border-primary px-2 py-1.5' type='password' {...field} id='passwordInput' />
              </FormControl>
              <FormMessage />
            </FormItem>
          )} />
